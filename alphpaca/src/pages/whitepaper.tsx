    ...
    return (
        <div className={`${styles.alignCenter} ${styles.textBox}`}>
            ...
            <div>
                ...
                Our main wallet will be secured through a 3/6 <Link href='/nft' className={styles.whitepaperLink} style={{color: 'orange'}}> multi-signature wallet </Link>. Our <Link href='/nft' className={styles.whitepaperLink} style={{color: 'orange'}}> &apos;hot wallet&apos; </Link> (non multi-sig) at any one time will not have more than 50K $PACA for giveaways and testing. <br/> <br/> 
